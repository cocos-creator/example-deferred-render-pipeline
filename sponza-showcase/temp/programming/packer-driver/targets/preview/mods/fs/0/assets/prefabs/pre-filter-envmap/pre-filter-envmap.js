    ...
    execute: function () {
      ...
      _export("PreFilterEnvmap", PreFilterEnvmap = (_dec = ccclass('PreFilterEnvmap'), _dec2 = property(EffectAsset), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function PreFilterEnvmap() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "blurriness", _descriptor2, _assertThisInitialized(_this));

          _defineProperty(_assertThisInitialized(_this), "_camera", null);

          _defineProperty(_assertThisInitialized(_this), "_material", null);

          _defineProperty(_assertThisInitialized(_this), "_renderTarget", null);
